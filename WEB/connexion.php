	...
	if(isset($_POST['username']) && isset($_POST['password'])){
		...
		foreach($rep as $key => $data){
           if ($data['LOGIN']==$_POST['username'] && $data['PASSWORD']==$_POST['password']) {
            	...
            	$_SESSION['statut'] = $data['STATUE'];
            	if($data['STATUE'] == "professeur"){
            		header('Location: choose-p.php');
            	}
            	else{
            		header('Location: choose-e.php');
            	}
           }
        	else { 
        		$panel="danger";
...
<body>
	<div class="container" >
		<div class="row" style="margin-top: 20%;">
			...
			<div class="panel panel-<?php echo $panel; ?> col-sm-offset-2 col-sm-8" style=" padding-left:0; padding-right:0;">
					...
					<div class="row">
						<form class="form-horizontal" action="connexion.php" method="POST">
							...
							<div class="form-group">
								<label class="col-sm-4 control-label" for="textinput">Identifiant:</label>  
								<div class="col-sm-4">
							...
							<!-- Password input-->
							<div class="form-group">
								<label class="col-sm-4 control-label" for="passwordinput">Mot de passe:</label>
								<div class="col-sm-4">
