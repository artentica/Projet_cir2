...
javac -cp /usr/share/java/junit4.jar:. /var/www/Projet_cir2/JAVA/TestRunner/Runner.java
java -cp /usr/share/java/junit4.jar:/var/www/Projet_cir2/JAVA/TestRunner/projet/test:. /var/www/Projet_cir2/JAVA/TestRunner/Runner