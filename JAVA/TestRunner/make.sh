...
javac /var/www/Projet_cir2/JAVA/TestRunner/projet/depot/RatesTest.java

#compile la classe de test
javac -cp /usr/share/java/junit4.jar:/var/www/Projet_cir2/JAVA/TestRunner/projet/depot:. /var/www/Projet_cir2/JAVA/TestRunner/projet/test/RatesTest.java
